...
namespace MicroZen.Api.Migrations
{
    ...
    [Migration("20240518025136_MakeOrganizationUserOrganizationsManyToMany")]
    partial class MakeOrganizationUserOrganizationsManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrganizationUserOrganization", b =>
                {
                    ...
                    b.HasOne("MicroZen.Data.Entities.OrganizationUser", null)
                        .WithMany()
